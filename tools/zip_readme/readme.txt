...
chr2img and tmx2c are both part of the nes-starter-kit, and released under the MIT license, which
is the same license nes-starter-kit is distributed under.

The scripts in the misc folder, as well as install_cygwin.bat are likewise under the MIT license.

Neslib was released to the public domain, as documented in its source code. 
